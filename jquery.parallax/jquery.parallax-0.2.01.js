 ...
 *  Requires jquery.schedule.js plugin to use the automove property
 *  Download from: http://trainofthoughts.org/repo/fileview?f=jquery/jquery.schedule.js&v=20
 * 
 * 0.2
...
(function($) {
  $.fn.parallax = function(options) {
    ...
    if(options.autoMove && (typeof(el.schedule) != 'undefined') ) {
    	...
    	$((options.useHTML) ? 'html' : this).mousemove(mouseMoveHandler);
    }
